...
- Design monocromático com destaque para fotos e serviços
- Ticker animado com palavras-chave (CORTE · BARBA · DEGRADÊ)
- Loader temático de poste de barbearia enquanto o mapa carrega
...
- **JavaScript:** Interações (menu mobile, lightbox, ticker, status em tempo real, soma de serviços)
- **Font Awesome:** Ícones vetoriais
- **Google Fonts:** Tipografia (Bebas Neue e DM Sans)
...
- Ticker animado com palavras-chave (CORTE · BARBA · DEGRADÊ)
- Cards de serviços com preços e ícones
- Promoção "Corte de Aniversário — 50% OFF"
- Galeria de fotos com lightbox (clique para ampliar)
- Depoimentos de clientes com estrelas
- **Seção de localização com:**
  - Blocos de informação (endereço, horário, WhatsApp, agendamento)
  - Loader temático (poste de barbearia com listras girando)
  - Mapa interativo do Google Maps
- Status de funcionamento em tempo real (aberto/fechado)
- Seleção de serviços com soma automática de valores
- Botão para consultar disponibilidade via WhatsApp
...
- style.css (estilos com tema monocromático)
